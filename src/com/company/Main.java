...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Question q5 = new Question("what is the capital of serbia? ", "  Kiev", "  Belgrade", "   London", 2);
        Question q6 = new Question("what is the capital of serbia? ", "  Kiev", "  Belgrade", "   London", 2);
        Question q7 = new Question("what is the capital of serbia? ", "  Kiev", "  Belgrade", "   London", 2);
        Question q8 = new Question("what is the capital of serbia? ", "  Kiev", "  Belgrade", "   London", 2);
        Question q9 = new Question("what is the capital of serbia? ", "  Kiev", "  Belgrade", "   London", 2);
        Question q10 = new Question("what is the capital of serbia? ", "  Kiev", "  Belgrade", "   London", 2);
